...
//This class in implementation of userdetails interface
//This encapsulates admin speciic details such as username, password and roles
//This class provides methods that Spring security uses to retrieve authentication and authorization
